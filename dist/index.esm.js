...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: 'Exchange',
                href: 'https://swap.kufarm.finance/',
            },
            {
                label: 'Liquidity',
                href: 'https://swap.kufarm.finance/#/pool',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            {
                label: 'Github',
                href: 'https://github.com/kufarm/',
            },
            {
                label: 'Docs',
                href: 'https://docs.kufarm.finance/',
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/kufarmKCC",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/kufarmkcc",
    },
];
var MENU_HEIGHT = 64;
...
var MoonIcon = Icons$1.MoonIcon, SunIcon = Icons$1.SunIcon, LanguageIcon = Icons$1.LanguageIcon;SettingsEntry
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        } }, accountEllipsis)) : (React.createElement(Button, { size: "sm", className: "kudex-btn", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#58ccb6", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
